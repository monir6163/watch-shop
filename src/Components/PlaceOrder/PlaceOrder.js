...
const PlaceOrder = () => {
    ...
    useEffect(() => {
        fetch(
            `https://watch-shop-server-production.up.railway.app/orders/${orderID}`
        )
            .then((res) => res.json())
            .then((data) => {
                setOrders(data);
    ...
    const onSubmit = (data) => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                data.order = orders;
                fetch(
                    "https://watch-shop-server-production.up.railway.app/placeorders",
                    {
                        method: "POST",
                        headers: {
                ...
                <div className="container mt-5 mb-5">
                    <div className="row">
                        <div className="col-md-8 col-12">
                            ...
                            <form
                                className="shadow-lg px-2 px-md-5 py-3 mt-4 text-cyan"
